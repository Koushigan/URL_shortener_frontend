async function login() {
    ...
    fetch('https://url-shortener-zqhg.onrender.com/login', {
            method: "POST",
            ...
            if (res.status == 200) {
                ...
                window.location.href = "https://url-shortener-zqhg.onrender.com/"
...
async function register() {
    ...
    fetch('https://url-shortener-zqhg.onrender.com/signup', {
            method: "POST",
            body: JSON.stringify(data),
            headers: {
                'content-Type': "application/json"
